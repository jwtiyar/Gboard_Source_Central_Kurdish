...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqux;->d:Ljava/lang/RuntimeException;

    return-void
.end method

.method public constructor <init>(Lquy;Lqmh;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentMap;)V
    .locals 2
    ...
    iput-object p1, p0, Lqux;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/lang/ref/SoftReference;

    sget-boolean v0, Lqux;->c:Z
    ...
    .line 10
    :cond_0
    sget-object v0, Lqux;->d:Ljava/lang/RuntimeException;

    .line 7
    :goto_0
    invoke-direct {p1, v0}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lqux;->h:Ljava/lang/ref/Reference;
    ...
    iput-object p1, p0, Lqux;->g:Ljava/lang/String;

    iput-object p3, p0, Lqux;->e:Ljava/lang/ref/ReferenceQueue;

    iput-object p4, p0, Lqux;->f:Ljava/util/concurrent/ConcurrentMap;

    .line 9
    invoke-interface {p4, p0, p0}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 10
    invoke-static {p3}, Lqux;->a(Ljava/lang/ref/ReferenceQueue;)V
...
.method private final a()V
    ...
    iget-object v0, p0, Lqux;->f:Ljava/util/concurrent/ConcurrentMap;

    .line 26
    invoke-interface {v0, p0}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lqux;->h:Ljava/lang/ref/Reference;
...
.method static a(Ljava/lang/ref/ReferenceQueue;)V
    ...
    iget-object v1, v0, Lqux;->h:Ljava/lang/ref/Reference;
    ...
    .line 13
    invoke-direct {v0}, Lqux;->a()V

    iget-object v2, v0, Lqux;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 16
    sget-object v3, Lquy;->b:Ljava/util/logging/Logger;
    ...
    sget-object v2, Lquy;->b:Ljava/util/logging/Logger;
    ...
    iget-object v0, v0, Lqux;->g:Ljava/lang/String;
    ...
    sget-object v0, Lquy;->b:Ljava/util/logging/Logger;
...
.method public final clear()V
    ...
    .line 23
    invoke-direct {p0}, Lqux;->a()V

    iget-object v0, p0, Lqux;->e:Ljava/lang/ref/ReferenceQueue;

    .line 24
    invoke-static {v0}, Lqux;->a(Ljava/lang/ref/ReferenceQueue;)V
