...
.method public constructor <init>(Landroid/content/Context;Lkzi;)V
    ...
    iput-object p1, p0, Lkpt;->a:Landroid/content/Context;

    iput-object p2, p0, Lkpt;->b:Lkzi;

    return-void
.end method

.method private final a(Ljava/io/OutputStreamWriter;Lkos;)V
    .locals 3

    .line 22
    :goto_0
    invoke-virtual {p2}, Lkos;->moveToNext()Z
    ...
    .line 23
    invoke-virtual {p2}, Lkos;->c()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lkos;->b()Ljava/lang/String;
...
.method public final run()V
    ...
    iget-object v3, p0, Lkpt;->a:Landroid/content/Context;

    .line 2
    invoke-static {v3}, Lkpw;->b(Landroid/content/Context;)Ljava/io/File;
    ...
    :try_start_2
    iget-object v4, p0, Lkpt;->a:Landroid/content/Context;

    iget-object v5, p0, Lkpt;->b:Lkzi;

    .line 6
    invoke-static {v4, v5}, Lkou;->a(Landroid/content/Context;Lkzi;)Lkot;
    ...
    .line 10
    sget-object v9, Lnxb;->b:Ljava/nio/charset/Charset;
    ...
    .line 15
    invoke-direct {p0, v8, v3}, Lkpt;->a(Ljava/io/OutputStreamWriter;Lkos;)V

    if-eqz v4, :cond_0

    .line 16
    invoke-virtual {v4}, Lkot;->getCount()I
    ...
    .line 18
    invoke-direct {p0, v8, v4}, Lkpt;->a(Ljava/io/OutputStreamWriter;Lkos;)V
    :try_end_7
    ...
    :try_start_c
    invoke-virtual {v4}, Lkot;->close()V
    :try_end_c
    .catchall {:try_start_c .. :try_end_c} :catchall_a

    :cond_1
    :try_start_d
    invoke-virtual {v3}, Lkoy;->close()V
    :try_end_d
    .catchall {:try_start_d .. :try_end_d} :catchall_c

    :try_start_e
    invoke-virtual {v2}, Lkpa;->close()V
    :try_end_e
    ...
    invoke-direct {v2, v1}, Lkpv;-><init>(Ljava/io/File;)V
