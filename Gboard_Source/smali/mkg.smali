...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lmkg;->d:J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lmkv;Lmkn;Lmjr;)V
    .locals 1
    ...
    iput-object v0, p0, Lmkg;->h:Landroid/util/SparseLongArray;

    iput-object p1, p0, Lmkg;->e:Landroid/content/Context;

    iput-object p2, p0, Lmkg;->f:Lmkv;

    iput-object p3, p0, Lmkg;->g:Lmkn;

    iput-object p4, p0, Lmkg;->i:Lmjr;
...
# virtual methods
.method public final a(Ljava/lang/String;Ljava/lang/String;)Lpbs;
    .locals 11
    ...
    :try_start_0
    iget-object v8, p0, Lmkg;->g:Lmkn;

    .line 28
    sget-object v9, Lmij;->e:Lmij;
    ...
    iput-object p2, v10, Lmij;->a:Ljava/lang/String;
    ...
    .line 33
    invoke-interface {v8, p1, v9, v10, v5}, Lmkn;->a(Ljava/lang/String;Lmij;ILandroid/os/IBinder;)Lmiz;
    ...
    .line 35
    invoke-direct {v8, p2, p1}, Lmkf;-><init>(Ljava/lang/String;Lpcg;)V

    invoke-interface {v6, v8}, Lmiz;->a(Lmjf;)V
    :try_end_0
    .catch Lmhg; {:try_start_0 .. :try_end_0} :catch_2
    ...
    .line 38
    :try_start_1
    invoke-interface {v6, v5}, Lmiz;->a(Landroid/os/IBinder;)V
    :try_end_1
    ...
    invoke-interface {v8, p1}, Lokv;->a(Ljava/lang/Throwable;)V

    const/16 v9, 0x92

    invoke-interface {v8, v4, v3, v9, v2}, Lokv;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    invoke-interface {v8, v0, p2}, Lokv;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v4, v3, v8, v2}, Lokv;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V

    const-string v8, "Training cache %s is currently in use, skip erasure."

    invoke-interface {v0, v8, p2}, Lokv;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmkg;->i:Lmjr;

    .line 44
    invoke-virtual {v0, p1}, Lmjr;->a(Ljava/lang/String;)Lmij;
    ...
    iget-object v6, p0, Lmkg;->f:Lmkv;

    .line 47
    invoke-interface {v6, p1}, Lmkv;->a(Ljava/lang/String;)I

    move-result v6

    iget-object v7, p0, Lmkg;->h:Landroid/util/SparseLongArray;
    ...
    iget-object v4, p0, Lmkg;->e:Landroid/content/Context;
    ...
    :cond_3
    iget-wide v7, v5, Lmik;->e:J

    iget-boolean v11, v5, Lmik;->f:Z

    iget-boolean v5, v5, Lmik;->g:Z
    ...
    iget-object v1, v0, Lmij;->a:Ljava/lang/String;

    const-string v2, "Cache erasure for %s not configured, using default value"

    invoke-interface {v5, v2, v1}, Lokv;->a(Ljava/lang/String;Ljava/lang/Object;)V

    sget-wide v7, Lmkg;->b:J
    ...
    iget-object v2, p0, Lmkg;->e:Landroid/content/Context;
    ...
    iget-object p1, v0, Lmij;->a:Ljava/lang/String;
...
.method public final a(Lmgr;Lmjc;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lmkg;->f:Lmkv;

    iget-object v4, p1, Lmij;->a:Ljava/lang/String;

    .line 13
    invoke-interface {v3, v0, v4}, Lmkv;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 15
    invoke-static {v3}, Lljz;->a(Ljava/lang/CharSequence;)Z
    ...
    .line 16
    invoke-interface {p2}, Lmjc;->asBinder()Landroid/os/IBinder;

    move-result-object v4

    iget-object v5, p0, Lmkg;->g:Lmkn;

    .line 17
    invoke-interface {v5, v3, p1, v0, v4}, Lmkn;->a(Ljava/lang/String;Lmij;ILandroid/os/IBinder;)Lmiz;

    move-result-object p1

    .line 18
    invoke-interface {p2, p1, v4}, Lmjc;->a(Lmiz;Landroid/os/IBinder;)V
    :try_end_0
    ...
    .line 20
    invoke-interface {p2, v0, p1}, Lmjc;->a(ILjava/lang/String;)V
    :try_end_1
