...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/learning/internal/InAppProxyService;->a:Lijb;
    ...
    :cond_0
    :try_start_0
    invoke-interface {v0, p1}, Lijb;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;
...
.method public final onCreate()V
    ...
    iput-object v2, p0, Lcom/google/android/gms/learning/internal/InAppProxyService;->a:Lijb;
    :try_end_0
    ...
    invoke-interface {v2, v3}, Lijb;->onCreate(Lhsz;)V
    :try_end_1
...
.method public final onDestroy()V
    ...
    .line 13
    :try_start_0
    invoke-interface {v0}, Lijb;->onDestroy()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onRebind(Landroid/content/Intent;)V
    ...
    .line 17
    :try_start_0
    invoke-interface {v0, p1}, Lijb;->onRebind(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 21
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lijb;->onStartCommand(Landroid/content/Intent;II)I
...
.method public final onTrimMemory(I)V
    ...
    .line 25
    :try_start_0
    invoke-interface {v0, p1}, Lijb;->onTrimMemory(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onUnbind(Landroid/content/Intent;)Z
    ...
    .line 28
    :try_start_0
    invoke-interface {v0, p1}, Lijb;->onUnbind(Landroid/content/Intent;)Z
