...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/learning/internal/training/InAppJobService;->a:Likd;

    if-eqz v0, :cond_0

    .line 2
    :try_start_0
    invoke-interface {v0}, Likd;->onDestroy()V
    :try_end_0
    ...
    const-string v1, "RemoteException in IInAppJobService.onCreate"
...
.method public final onRebind(Landroid/content/Intent;)V
    ...
    .line 6
    :try_start_0
    invoke-interface {v0, p1}, Likd;->onRebind(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 10
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Likd;->onStartCommand(Landroid/content/Intent;II)I
...
.method public final declared-synchronized onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 31
    :cond_0
    invoke-static {p0, p1}, Lika;->a(Landroid/content/Context;Landroid/app/job/JobParameters;)V
    :try_end_0
    ...
    .line 27
    sget-object v3, Likq;->a:Lijl;

    .line 17
    invoke-static {p0, v0, v3}, Lijm;->a(Landroid/content/Context;Ljava/lang/String;Lijl;)Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Likd;
    :try_end_2
    .catch Lijk; {:try_start_2 .. :try_end_2} :catch_2
    ...
    .line 21
    sget-object v4, Likr;->a:Ljava/util/concurrent/ExecutorService;

    .line 20
    invoke-static {v4}, Lhta;->a(Ljava/lang/Object;)Lhsz;

    move-result-object v4

    invoke-interface {v0, v3, v4}, Likd;->init(Lhsz;Lhsz;)Z
    ...
    .line 26
    :cond_3
    iput-object v0, p0, Lcom/google/android/gms/learning/internal/training/InAppJobService;->a:Likd;
    :try_end_4
    ...
    .line 27
    invoke-interface {v0, p1}, Likd;->onStartJob(Landroid/app/job/JobParameters;)Z
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 32
    :try_start_0
    invoke-interface {v0, p1}, Likd;->onStopJob(Landroid/app/job/JobParameters;)Z
...
.method public final onTrimMemory(I)V
    ...
    .line 35
    :try_start_0
    invoke-interface {v0, p1}, Likd;->onTrimMemory(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onUnbind(Landroid/content/Intent;)Z
    ...
    .line 38
    :try_start_0
    invoke-interface {v0, p1}, Likd;->onUnbind(Landroid/content/Intent;)Z
