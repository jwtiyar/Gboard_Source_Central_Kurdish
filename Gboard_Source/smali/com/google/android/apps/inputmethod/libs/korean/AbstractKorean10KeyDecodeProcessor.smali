...
.method static constructor <clinit>()V
    ...
    invoke-direct {v6, v7, v8, v3}, Lkgp;-><init>(ILkgo;Ljava/lang/Object;)V

    .line 4
    invoke-virtual {v1, v5, v6}, Lodz;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sput-object v0, Lcom/google/android/apps/inputmethod/libs/korean/AbstractKorean10KeyDecodeProcessor;->e:Loed;
...
.method protected static a(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :goto_0
    new-instance p1, Lemr;

    invoke-direct {p1, p3, p4}, Lemr;-><init>(Ljava/lang/String;Z)V
...
.method protected final a(Landroid/view/inputmethod/EditorInfo;Z)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/inputmethod/libs/korean/AbstractKorean10KeyDecodeProcessor;->r:Lkrm;
    ...
    .line 21
    invoke-virtual {p1, p2, v0}, Lafd;->b(II)I
...
.method protected final b(Ljqo;)Z
    ...
    :cond_1
    iget-object v5, v6, Lemr;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/korean/AbstractKorean10KeyDecodeProcessor;->j:Lejn;
    ...
    iget-object v4, p0, Lcom/google/android/apps/inputmethod/libs/korean/AbstractKorean10KeyDecodeProcessor;->j:Lejn;

    .line 14
    invoke-interface {v4, v1}, Lejn;->b(Z)Z
    ...
    sget-object v2, Lcom/google/android/apps/inputmethod/libs/korean/AbstractKorean10KeyDecodeProcessor;->e:Loed;
    ...
    iget-wide v6, p1, Ljqo;->f:J

    iput-wide v6, v2, Ljqo;->f:J

    .line 17
    invoke-virtual {p0, v2}, Lcom/google/android/apps/inputmethod/libs/korean/HmmKoreanDecodeProcessor;->d(Ljqo;)Z
    ...
    .line 18
    :goto_3
    invoke-virtual {p0, v2, v4}, Lcom/google/android/apps/inputmethod/libs/korean/HmmKoreanDecodeProcessor;->a(Ljqo;Z)V
    ...
    .line 19
    :cond_7
    invoke-super {p0, p1}, Lcom/google/android/apps/inputmethod/libs/korean/HmmKoreanDecodeProcessor;->b(Ljqo;)Z
