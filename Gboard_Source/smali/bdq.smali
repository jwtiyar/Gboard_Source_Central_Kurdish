...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbdq;->b:Landroid/graphics/Paint;
    ...
    sput-object v0, Lbdq;->d:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lbdq;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sput-object v0, Lbdq;->c:Landroid/graphics/Paint;
...
.method public static a(Laxo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    .line 22
    invoke-static {p1}, Lbdq;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Laxo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    .line 23
    invoke-static {p1, p0}, Lbdq;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    .line 24
    invoke-static {p1, p0, v0}, Lbdq;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Lbdq;->b:Landroid/graphics/Paint;
    ...
    .line 12
    sget-object p0, Lbdq;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 10
    sget-object p1, Lbdq;->a:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Laxo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    .line 37
    invoke-interface {p0, p3, v0, v1}, Laxo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 41
    invoke-static {p1, p0, p3}, Lbdq;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Laxo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p1, p2, p3}, Lbdq;->b(Laxo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
