...
.method public final a(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-boolean v0, p0, Ljsj;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Ljsj;->d:Lolg;
    ...
    .line 14
    invoke-virtual {v0}, Lolg;->b()Ljava/lang/String;
    ...
    .line 18
    :cond_0
    invoke-static {p1}, Ljsj;->b(Ljava/util/logging/Level;)I
    ...
    new-instance p3, Ljsh;

    .line 21
    invoke-direct {p3}, Ljsh;-><init>()V

    :cond_1
    iget-object p1, p0, Ljsj;->a:Ljava/lang/String;
...
.method public final a(Loma;)V
    ...
    .line 26
    invoke-interface {p1}, Loma;->e()Lolg;

    move-result-object v0

    iput-object v0, p0, Ljsj;->d:Lolg;

    .line 27
    sget-object v0, Loml;->b:Lomj;
