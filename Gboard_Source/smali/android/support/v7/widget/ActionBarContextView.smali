...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    invoke-virtual {p1, p2, v1}, Lzd;->f(II)I
    ...
    .line 8
    invoke-virtual {p1, p2, v1}, Lzd;->e(II)I
    ...
    .line 9
    invoke-virtual {p1, p2, p3}, Lzd;->f(II)I
...
.method public final a(Lqa;)V
    ...
    .line 19
    invoke-direct {v2, p1}, Lsc;-><init>(Lqa;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 20
    invoke-virtual {p1}, Lqa;->b()Landroid/view/Menu;

    move-result-object p1

    check-cast p1, Lrb;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lso;
    ...
    invoke-direct {v0, v2}, Lso;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lso;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lso;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    .line 25
    invoke-virtual {p1, v2, v3}, Lrb;->a(Lrp;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lso;

    iget-object v2, p1, Lso;->f:Lrr;

    iget-object v3, p1, Lqo;->f:Lrr;

    if-nez v3, :cond_3

    iget-object v3, p1, Lqo;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lqo;->f:Lrr;

    iget-object v1, p1, Lqo;->f:Lrr;

    iget-object v3, p1, Lqo;->c:Lrb;

    .line 27
    invoke-interface {v1, v3}, Lrr;->a(Lrb;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Lso;)V
    ...
    .line 31
    invoke-static {p1, v1}, Lkz;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 57
    :cond_0
    invoke-super {p0, p1}, Lsa;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
