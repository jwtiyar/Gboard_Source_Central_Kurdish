...
.method private static a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;
    ...
    .line 50
    :cond_1
    invoke-static {v1, p0, v0}, Llbi;->a(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
...
.method private final a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
    ...
    .line 31
    invoke-direct/range {v0 .. v5}, Ldva;-><init>(Ldvb;Ljava/lang/Runnable;Landroid/view/View;FF)V

    invoke-virtual {v14, v6}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    move-object/from16 v0, p0

    iput-object v14, v0, Ldvb;->a:Landroid/animation/Animator;
...
.method protected final a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/libraries/inputmethod/widgets/SoftKeyView;->a(Lkfp;)Lkfv;
    ...
    invoke-virtual {p0, v2, p2}, Ldvb;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
...
.method public final a()V
    ...
    iget-object v0, p0, Ldvb;->a:Landroid/animation/Animator;
...
.method public final a(Landroid/view/View;Landroid/view/View;Ljava/lang/String;ILjava/lang/String;ILjava/lang/Runnable;)Z
    ...
    .line 2
    invoke-virtual/range {p0 .. p6}, Ldvb;->a(Landroid/view/View;Landroid/view/View;Ljava/lang/String;ILjava/lang/String;I)Z
    ...
    invoke-static {p1, p4, p6}, Ldvb;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object p4

    .line 5
    invoke-virtual {p0, p2, p3}, Ldvb;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 7
    invoke-static {p2, p3, v1}, Ldvb;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object p2

    .line 8
    invoke-direct {p0, p1, p4, p2, p7}, Ldvb;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
    ...
    .line 11
    invoke-virtual {p0, p1, p5}, Ldvb;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 12
    invoke-static {p1, p3, v1}, Ldvb;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;
    ...
    invoke-static {p2, p3, p6}, Ldvb;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object p3

    .line 14
    invoke-direct {p0, p2, p1, p3, p7}, Ldvb;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
